...
const AddressIcon = ({ width = '20', height = '20' }) => {
    return (
        <svg
            enableBackground='new 0 0 512 512'
            width={width}
...
const ReviewIcon = ({ width = '60', height = '60' }) => {
    return (
        <svg
            enableBackground='new 0 0 512 512'
            width={width}
...
const TrashIcon = ({ width = '20', height = '20' }) => {
    return (
        <svg
            xmlns='http://www.w3.org/2000/svg'
            width={width}
...
const XIcon = ({ width = '20', height = '20' }) => {
    return (
        <svg
...
const ArrowBackIcon = ({ width = '20', height = '20' }) => {
    return (
        <svg
            xmlns='http://www.w3.org/2000/svg'
            width={width}
