...
### Key Features
  ...
  - 🔗 User authentication via Google and Facebook for easy access.
  - 🔗 Admin dashboard for administrators to manage the platform efficiently.
  - 🔗 User-friendly interface for customers to explore and purchase products.
  - 🔗 Create, update, and delete categories with support for nested categories.
  - 🔗 Product management, including creation, updating, and deletion.
  - 🔗 "Featured" product option for highlighting products on the homepage.
  - 🔗 Brand management to categorize products by brand.
  - 🔗 Size management to define available product sizes.
  - 🔗 Cloudinary integration for uploading and managing multiple product images. 
  - 🔗 Advanced search and filter options for categories, products, sizes, and price ranges with pagination.
  - 🔗 Order history and sales analytics, including graphs and revenue overviews.
  - 🔗 Seamless order creation and the ability to add products to the cart.
  - 🔗 Multiple payment options, including Stripe, PayPal, and cash.
...
🔹3: Open your browser and navigate to http://localhost:3000 to access the Ziwishop application.
...
## Orders and Sales
Users can view their order history, and administrators have access to sales analytics. Graphs display best-selling products and revenue overviews on a weekly basis.
...
<h4> If you'd like to support my work , feel free to star ⭐
              my repo or you can contact me so we can enjoy a coffee together ☕️❤️‍🔥</h4>
